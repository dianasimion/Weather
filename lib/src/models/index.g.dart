...
class _$CurrentSerializer implements StructuredSerializer<Current> {
  ...
  Iterable<Object?> serialize(Serializers serializers, Current object,
    ...
    final result = <Object?>[];
    Object? value;
    value = object.temperatureKelvin;
    if (value != null) {
  ...
  Current deserialize(Serializers serializers, Iterable<Object?> serialized,
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'temp':
          result.temperatureKelvin = serializers.deserialize(value, specifiedType: const FullType(double)) as double?;
          break;
      }
    }
...
class _$Current extends Current {
  ...
  _$Current._({this.temperatureKelvin}) : super._();
  ...
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is Current && temperatureKelvin == other.temperatureKelvin;
  }

  @override
  int get hashCode {
    return $jf($jc(0, temperatureKelvin.hashCode));
  }

  @override
  String toString() {
    return (newBuiltValueToStringHelper('Current')..add('temperatureKelvin', temperatureKelvin)).toString();
  }
}
...
class CurrentBuilder implements Builder<Current, CurrentBuilder> {
  ...
  set temperatureKelvin(double? temperatureKelvin) => _$this._temperatureKelvin = temperatureKelvin;
  ...
  @override
  _$Current build() {
    final _$result = _$v ?? new _$Current._(temperatureKelvin: temperatureKelvin);
    replace(_$result);
    return _$result;
  }
}
